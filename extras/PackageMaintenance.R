...
OhdsiRTools::checkUsagePackage("CRCmetformin")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CRCmetformin.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CRCmetformin.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CRCmetformin")
