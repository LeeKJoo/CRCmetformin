...
2. In `R`, use the following `devtools` command to install the CRCmetformin package:
...
License
=======
The CRCmetformin package is licensed under Apache License 2.0

Development
===========
CRCmetformin was developed in ATLAS and R Studio.
